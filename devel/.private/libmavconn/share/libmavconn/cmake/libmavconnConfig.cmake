...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/hemanth/neural_fly/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/hemanth/neural_fly/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/hemanth/neural_fly/install)
...
if(NOT "/home/hemanth/neural_fly/src/mavros/libmavconn/include;/usr/include;/opt/ros/melodic/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/hemanth/neural_fly/src/mavros/libmavconn/include;/usr/include;/opt/ros/melodic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hemanth/neural_fly/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hemanth/neural_fly/devel/.private/libmavconn/lib;/home/hemanth/neural_fly/devel/lib;/home/hemanth/catkin_ws1/devel/lib;/opt/ros/melodic/lib)
